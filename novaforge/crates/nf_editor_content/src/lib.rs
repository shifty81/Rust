...
use nf_assets::{AssetRegistry, AssetKind};
...
fn draw_content_panel(
    ...
    egui::TopBottomPanel::bottom("nf_content_browser")
        ...
        .show(ctx, |ui| {
            ...
            ui.horizontal(|ui| {
                // Folder tree (left)
                egui::SidePanel::left("nf_content_folders")
                    .default_width(160.0)
                    .resizable(true)
                    .show_inside(ui, |ui| {
                        ui.label("Content/");
                ...
                egui::ScrollArea::vertical().show(ui, |ui| {
                    ...
                    if assets.is_empty() {
                        ...
                        egui::Grid::new("nf_asset_grid").show(ui, |ui| {
