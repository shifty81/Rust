...
fn update_sky_color(
    ...
    mut sun_light_query: Query<&mut DirectionalLight, With<SunLight>>,
    ...
    if let Ok(mut sun_light) = sun_light_query.get_single_mut() {
...
fn animate_weather_particles(
    ...
    mut particle_query: Query<&mut Transform, With<WeatherParticle>>,
    ...
    for mut tf in &mut particle_query {
